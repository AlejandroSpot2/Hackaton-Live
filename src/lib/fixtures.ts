...
export const RUNNING_RUN: Run = {
  ...
  brief: {
    ...
    pain: "20+ minutes every Sunday stressing about meals, random leftovers rotting by Thursday, food waste from unplanned purchases",
    current_alternative: "Pinterest boards they never revisit, Google \"easy weeknight dinners,\" manually write grocery lists on Notes app.",
    why_now: "Multimodal vision models (GPT-4o, Gemini) finally make fridge-scanning accurate enough; Instacart/Walmart APIs allow one-tap ordering from the generated list.",
    biggest_risk: "Habit formation is brutally hard — retention after week 3 will likely collapse unless there's an aggressive notification loop.",
    constraints: [],
    unknowns: [],
  },
  events: [
    { id: "evt_101", run_id: "run_live_002", type: "created", message: "Run created from voice intake", sponsor: "vapi", created_at: new Date().toISOString() },
    { id: "evt_102", run_id: "run_live_002", type: "research_started", message: "Launching 5 research lanes: competitors, substitutes, pain, pricing, why_now", sponsor: "tinyfish", created_at: new Date().toISOString() },
    { id: "evt_103", run_id: "run_live_002", type: "evidence_found", message: "Found Mealime, Paprika, Whisk — meal planning incumbents with large user bases", sponsor: "tinyfish", created_at: new Date().toISOString() },
  ],
  evidence: [
    {
      id: "ev_101",
      ...
      title: "Mealime — Meal Planning Made Simple",
      snippet: "Mealime helps 4M+ users plan weekly meals and generate grocery lists. Premium at $5.99/month.",
      claim: "Mealime has 4M+ users — validates demand, but no fridge scanning or vision AI",
      evidence_type: "competitor",
      confidence: 0.93,
      source_tool: "tinyfish_search",
    },
    {
      id: "ev_102",
      run_id: "run_live_002",
      url: "https://reddit.com/r/mealplanning",
      title: "r/mealplanning — What do you use to plan meals?",
      snippet: "Top comment: 'I just Google recipes on Sunday and wing it. Every app I've tried requires too much manual input.'",
      claim: "Manual input friction is the #1 reason meal planning apps fail to retain users",
      evidence_type: "pain",
      confidence: 0.91,
      source_tool: "tinyfish_fetch",
    },
